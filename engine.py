...
class Highscore:
    def __init__(self):
        ...
        self.ratio = str(row[4])
        self.ratio2 = str(row2[4])
        self.ratio3 = str(row3[4])
        self.ratio4 = str(row4[4])
        self.ratio5 = str(row5[4])
    ...
    def Draw(self):
        ...
        Text_draw(self.ratio, 40, self.X+650, self.Y+50)
        Text_draw(self.ratio2, 40, self.X+650, self.Y+90)
        Text_draw(self.ratio3, 40, self.X+650, self.Y+130)
        Text_draw(self.ratio4, 40, self.X+650, self.Y+170)
        Text_draw(self.ratio5, 40, self.X+650, self.Y+210)
...
class Endgame:
    def __init__(self):
        ...
        self.gamesl4 = str(row4[3])
        self.gamesl5= str(row5[3])
        self.gamesl6= str(row6[3])

        self.ratio = str(row[4])
        self.ratio = str(row2[4])
        self.ratio = str(row3[4])
        self.ratio = str(row4[4])
        self.ratio = str(row5[4])
        ...
        self.Buttons = [
        Button(self.X-300, self.Y+522, 100, 57, self.Menu, self.button_color, self.button_color_hover, "main"),\
        Button(self.X-200, self.Y+400, 100, 57, self.Update_score, self.button_color, self.button_color_hover, "update")]

    def Update_score(self):
        #cur.execute ("""INSERT INTO score (name, gamesp, gamesw, gamesl) VALUES(%s, %s, %s, %s)""", (self.P1, self.GP, self.GW, self.GL))
        cur.execute("UPDATE score SET gamesp = gamesp+1, gamesw = gamesw+1, gamesl = gamesl WHERE name = '{}'".format(self.name9))
        cur.execute("UPDATE score SET gamesp = gamesp+1, gamesw = gamesw, gamesl = gamesl+1 WHERE name = '{}'".format(self.name10))
    ...
    def Draw(self):
        ...
        Text_draw(self.name, 70, self.X+25, self.Y+50)
        Text_draw(self.name2, 50, self.X+600, self.Y+50)

        Text_draw(self.gamesp, 40, self.X+25, self.Y+200)
        Text_draw(self.gamesp2, 40, self.X+25, self.Y+275)

        Text_draw(self.gamesw, 40, self.X+100, self.Y+200)
        Text_draw(self.gamesw2, 40, self.X+100, self.Y+275)

        Text_draw(self.gamesl, 40, self.X+175, self.Y+200)
        Text_draw(self.gamesl2, 40, self.X+175, self.Y+275)
...
class Menu:
    def __init__(self):
        ...
        Button(self.X+93, self.Y+320, 498, 69, self.Load, self.button_color, self.button_color_hover, "Load game"),\
...
boat3 = pygame.image.load("C:\\Users\\Gregory\\Desktop\\end-game\\2.png")
game.loop()
