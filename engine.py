...
try: conn = psycopg2.connect("dbname=battleport user=postgres host=localhost password=gregory123")
...
class Rules:
    def __init__(self):
        ...
        self.current1=0
        self.L_Rules=[\
        pygame.transform.scale(pygame.image.load("images//Rules list//generalRules.png"),(600,600)),\
        pygame.transform.scale(pygame.image.load("images//Rules list//shipRules.png"),(600,600)),\
        pygame.transform.scale(pygame.image.load("images//Rules list//shipstats1of2.png"),(600,600)),\
        pygame.transform.scale(pygame.image.load("images//Rules list//shipstats2of2.png"),(600,600)),\
        pygame.transform.scale(pygame.image.load("images//Rules list//cardRules1of2.png"),(600,600)),\
        pygame.transform.scale(pygame.image.load("images//Rules list//cardRules2of2.png"),(600,600)),\
        pygame.transform.scale(pygame.image.load("images//Rules list//cardinformation1of4.png"),(600,600)),\
        pygame.transform.scale(pygame.image.load("images//Rules list//cardinformation2of4.png"),(600,600)),\
        pygame.transform.scale(pygame.image.load("images//Rules list//cardinformation3of4.png"),(600,600)),\
        pygame.transform.scale(pygame.image.load("images//Rules list//cardinformation4of4.png"),(600,600)),\
        ]
    ...
    def Loop(self):
        while not self.Exit:
            ...
            if self.Level == "menu":
                ...
                self.Display.blit(pygame.image.load("C:\\Users\\Gregory\\Desktop\\HIGHSCORE_MENU(2)\\1.png"),(0,0))
                highscore.Draw()
                pygame.display.update()
                self.Tick()
